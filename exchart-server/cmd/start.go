...
import (
	...
	"github.com/beati/exchart/exchart-server/assets"
	"github.com/beati/exchart/exchart-server/domain"
	"github.com/beati/exchart/exchart-server/interfaces/email/mailgun"
	"github.com/beati/exchart/exchart-server/interfaces/persistence/postgres"
	"github.com/beati/exchart/exchart-server/interfaces/pwhash"
	"github.com/beati/exchart/exchart-server/interfaces/session"
	"github.com/beati/exchart/exchart-server/interfaces/webservice"
...
var startCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		mailer := mailgun.New(mailgunConfig.APIKey, mailgunConfig.Domain, "ExChart", "noreply")
